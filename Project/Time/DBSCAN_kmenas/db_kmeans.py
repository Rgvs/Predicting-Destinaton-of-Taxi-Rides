...
class Dbscan:
    ...
    def __init__(self):
        ...
        self.mongo_train = self.mongo_db['160_daytype_A']
    ...
    def db(self):
        ...
        for coordinates in t:
            ...
            try:
                ...
                print coordinates,"1"
                try:
                    trans.append ([ float(coordinates[0][1:-1]),float(coordinates[1][:-1])] )
                except:
                    print coordinates,"2"
                    pass
        ...
        for line in izip(open('start_n_transition_end1.txt')):   ####need this fileeeee
        ...
        for tup in self.mongo_train.find( {"$and" : [ 
            ...
            x_t= float(tup["POLYLINE"][12][0]) #getting transition
            y_t= float(tup["POLYLINE"][12][1])
            #print tup["POLY"]
