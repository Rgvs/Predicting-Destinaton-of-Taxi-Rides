...
class Dbscan:
    ...
    def db(self):
        ...
        MISSING=0
        for line in izip(open('train.txt')):   ####need this fileeeee
        ...
        for tup in self.mongo_train.find({ '$and':[{'TIME.month': 9},{'DIRTY':0} ]}):
            ...
            print total_distance_new/trips, new_distance, count_good, count_avg, count_bad, tup['TIME']['dayofmonth'],MISSING,trips
            #if trips==14000:
            #    break
            #break
