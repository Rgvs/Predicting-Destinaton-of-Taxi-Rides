...
class Dbscan:
    ...
    def db(self):
        ...
        f1 = open('K_start_Kaggle_CA.txt' ,'r')
        st=f1.read().split('\n')
        for coordinates in st:
            ...
            try:
                ...
                print coordinates
                pass
        f1 = open('K_transition_Kaggle_CA.txt' ,'r')
        t=f1.read().split('\n')
        ...
        MISSING=0
        for line in izip(open('trainA1.txt')):   ####need this fileeeee
        ...
        count_good=count_avg=count_bad=count_good1=count_avg1=count_bad1=0
        for tup in self.mongo_train.find({ '$and':[{'TIME.dayofyear': {'$lt': 277 } }, {'TIME.dayofyear': {'$gte': 270 } },{'DIRTY':0} ]}):
            ...
            x_t= float(tup["POLYLINE"][20][0]) #getting transition
            y_t= float(tup["POLYLINE"][20][1])
            #print tup["POLY"]
            ...
            if haversine( a, b, x_last, y_last) <2000:
                ...
                count_bad1+=1   		
            print total_distance/trips, count_good1, count_avg1, count_bad1
            print total_distance_new/trips, count_good, count_avg, count_bad,MISSING,trips
            #if trips==100:
            #    break
            #break
